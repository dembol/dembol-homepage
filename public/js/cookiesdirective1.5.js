...
function cdHandler(disclosurePosition, privacyPolicyUri, cookieScripts) {
	...
	disclosure += 'cookies from this site, but parts of the site will not work. ';
	...
	disclosure += '<br/><br/>';
	disclosure += '<input type="submit" name="epdsubmit" id="epdsubmit" value="I accept cookies from this site"/><br/><br/></div></div>';
